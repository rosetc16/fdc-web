...
export const SEASON_STEPS = [
  ...
  ['ti-first-aid-kit', 'Check every league at once', 'week:myweek',
    'My Teams is the across-all-leagues view — the lineups still needing a decision, who is questionable, who is on a bye. On a Sunday morning it replaces opening eighteen tabs.'],
...
export const GUIDE_MAP = [
  ...
  },
  {
    ...
    blurb: 'Two entry points. My Teams and Game Day look ACROSS every league you own; the league hub looks INSIDE one of them.',
    items: [
      { name: 'My Teams', find: 'Home → My Teams',
        at: 'week:myweek',
      ...
      { name: 'Review', find: 'Home → My Teams → Review',
        at: 'week:review',
